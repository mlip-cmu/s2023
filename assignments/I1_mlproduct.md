...
* 20p: The document describes how image search is implemented and we can find the corresponding implementation. A machine-learned model was used in the implementation. The application is functional to search for images with keywords that are matched objects in those images.
