...
* *Team process and meeting notes* (1 page of text max, figures do not count toward the page limit): Briefly describe how your team organizes itself. What communication channels do you use? How do you divide the work? How do you assign responsibilities? What steps have you taken to avoid future teamwork problems? Include a screenshot of (or link to) notes taken at team meetings that describe how how work was divided, who was responsible for what, by when. (Also a TA will reach out to you after the milestone for a meeting talking about teamwork.)
...
**Technical details:** For model accuracy, we accept a wide range of possible metrics, including proxies that provide only partial insights about accuracy. Make a judgement about what metric is appropriate for the problem and feasible to implement.
