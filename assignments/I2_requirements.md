...
1. **Goals** (2 pages max): Provide a list of organizational objectives, leading indicators, system goals, user outcomes, and model properties and corresponding measures.
...
* [ ] 10 points: Goals are listed and appropriately grouped. There is at least one goal for each of the five categories of goals. The goals relate to the scenario and are reasonably complete.
